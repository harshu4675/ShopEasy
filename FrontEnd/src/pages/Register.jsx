        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-6 max-md:mb-5">
            ...
            <p className="m-0 text-sm text-gray-500">
              Get exclusive access to deals, early releases, and more
            </p>
          </div>
              ...
              >
                ...
                <div className="mr-4 flex items-center">
                  ...
                  {!phoneChecking && phoneAvailable === false && (
                    <span style={matIcon} className="text-[22px] text-red-500">
                      cancel
                    </span>
                  )}
                </div>
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            animation: "reg-blob 8s ease-in-out infinite",
          }}
        />
        <div
          ...
          style={{
            ...
            animation: "reg-blob 8s ease-in-out 2s infinite",
          }}
        />
        ...
        <div className="relative z-10 flex w-full flex-col justify-between p-16">
          ...
          <div className="max-w-md">
            ...
            <p className="mb-10 text-base leading-relaxed text-pink-100">
              Create your account and unlock exclusive member perks, early
              access to new collections, and personalized style recommendations.
            </p>
              ...
              {[
                {
                  ...
                  desc: "On your first order with code WELCOME100",
                },
                {
                  icon: "local_offer",
                  title: "Exclusive Coupons",
                  desc: "Member-only discounts and deals",
                },
                {
                  icon: "notifications_active",
                  title: "Early Access",
                  desc: "Be first to shop new arrivals",
                },
                {
                  icon: "favorite",
                  title: "Save Favorites",
                  desc: "Build wishlists and track your style",
                },
              ].map((item) => (
                <div
                  key={item.title}
